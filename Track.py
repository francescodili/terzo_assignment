...
class Track:
    def __init__(self, track_id, bbox, crop, max_frames_to_skip=5):
        ...
        track_id: Identificatore unico della traccia.
        bbox: Bounding box della traccia.
        crop: Crop della traccia.
        max_frames_to_skip: Numero massimo di frame che possono essere saltati prima che la traccia venga considerata persa.
        """
    ...
    def update(self, bbox, crop):
        ...
        bbox: Nuova bounding box della traccia.
        crop: Nuovo crop della traccia.
        """
        self.bbox = bbox
        self.crop = crop
        self.skipped_frames = 0
